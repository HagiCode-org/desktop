...
export function isOperationActive(progress?: NpmManagementOperationProgress): boolean {
...
export function isBatchSyncEvent(batchSyncState: BatchSyncState | null, event: NpmManagementOperationProgress): boolean {
  return Boolean(
    batchSyncState
...
export function appendBatchSyncLog(
  ...
  event: NpmManagementOperationProgress,
): BatchSyncState {
