...
assert.match(prepareScript, /\[\.\.\.npmCommand\.args,\s*'pack',\s*`better-sqlite3@\$\{betterSqlite3Version\}`\]/, 'prepare script fetches the exact better-sqlite3 tarball without reinstalling the whole OmniRoute app tree');
