...
assert.match(prepareScript, /'tar', \['-xzf', archivePath, '--strip-components=1', '-C', betterSqlite3Root\]/, 'prepare script expands the packed better-sqlite3 tarball directly into the vendored runtime');
