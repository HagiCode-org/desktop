...
assert.match(prepareScript, /'install', '--no-save', '--no-package-lock', `better-sqlite3@\\$\\{betterSqlite3Version\\}`/, 'prepare script restores the exact better-sqlite3 package when vendored payload omits source files');
