...
**Given** 用户数据目录路径包含空格（如 `/home/user/.config/Hagico Desktop/pcode-web/installed/linux-x64/start.sh`）
...
**Given** 用户数据目录路径包含空格（如 `C:\Users\user\AppData\Roaming\Hagico Desktop\pcode-web\installed\win-x64\PCode.Web.exe`）
**When** PCodeWebServiceManager 启动 Web 服务进程
**Then** 进程成功启动
...
**Given** 用户数据目录路径包含空格（如 `/Users/user/Library/Application Support/Hagico Desktop/pcode-web/installed/osx-x64/PCode.Web`）
**When** PCodeWebServiceManager 启动 Web 服务进程
**Then** 进程成功启动
