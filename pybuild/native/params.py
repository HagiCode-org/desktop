...
DEFAULT_CLOUDFLARE_PUBLIC_BASE_URL = "https://dl-desktop.hagicode.com"
...
class BuildParams:
    ...
    cloudflare_public_base_url: str = DEFAULT_CLOUDFLARE_PUBLIC_BASE_URL
...
PARAM_ALIASES: dict[str, str] = {
    ...
    "r2uploadconcurrency": "azure_upload_concurrency",
    "minifyindexjson": "minify_index_json",
    "azureindexoutputpath": "azure_index_output_path",
    "r2indexoutputpath": "azure_index_output_path",
    "azureuploadplanoutputpath": "azure_upload_plan_output_path",
    "r2uploadplanoutputpath": "azure_upload_plan_output_path",
    "azureuploadmatrixoutputpath": "azure_upload_matrix_output_path",
    "r2uploadmatrixoutputpath": "azure_upload_matrix_output_path",
    ...
    "r2maxparallel": "azure_max_parallel",
...
def parse_passthrough(args: Iterable[str]) -> BuildParams:
    ...
    env_cf = os.environ.get("R2_CLOUDFLARE_PUBLIC_BASE_URL", "").strip()
    if env_cf:
        params.cloudflare_public_base_url = env_cf
